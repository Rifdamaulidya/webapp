...
st.write('### Constructing Hypothesis') #semakin banyak tanda pagar semakin kecil hurufnya
...
if clicked:
    ...
    z_score, p_value = ztest(df['grades'], value=null_mean, alternative='two-sided') #bisa diganti smaller atau larger
